/*
  ...
  - Added the required column `habitId` to the `habit_week_day ` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_habit_week_day " (
    ...
    CONSTRAINT "habit_week_day _habitId_fkey" FOREIGN KEY ("habitId") REFERENCES "habits" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
